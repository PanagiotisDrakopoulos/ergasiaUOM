$("document").ready(function () {
  ...
  function skipToEnd() {
    ...
    const error =
      currentLanguage === "greek"
        ? "Λυπούμαστε αλλά δεν δικαιούστε το στεγαστικό επίδομα!"
        : "We are sorry, but you are not eligible for the housing allowance.";
  ...
  function submitForm() {
    ...
    currentLanguage === "greek"
      ? $(".question-container").append(
          "<br /><br /><h5 class='answer'>Τα δικαιολογητικά που πρέπει να προσκομίσετε για να λάβετε το στεγαστικό επίδομα είναι τα εξής:</h5><br />"
        )
      : $(".question-container").append(
          "<br /><br /><h5 class='answer'>The documents you need to provide in order to receive your housing allowance are the following:</h5><br />"
        );
